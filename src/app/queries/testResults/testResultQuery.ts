const queryBody = 'SELECT `tr`.`id`, JSON_OBJECT('
  ...
  + "'createdAt', DATE_FORMAT(`tr`.`createdAt`, '%Y-%m-%d %H:%i:%s'), "
  + "'lastUpdatedAt', DATE_FORMAT(`tr`.`lastUpdatedAt`, '%Y-%m-%d %H:%i:%s'), "
  + "'testCode', `testCode`, "
  ...
  + "'testTypeStartTimestamp', DATE_FORMAT(`tr`.`testTypeStartTimestamp`, '%Y-%m-%d %H:%i:%s'), "
  + "'testTypeEndTimestamp', DATE_FORMAT(`tr`.`testTypeEndTimestamp`, '%Y-%m-%d %H:%i:%s'), "
