...
const TEST_RECORD_BY_VIN = `${queryBody} WHERE \`v\`.\`vin\` = ?`;
const TEST_RECORD_BY_VRM = `${queryBody} WHERE \`v\`.\`vrm_trm\` = ?`;
const TEST_RECORD_BY_TEST_NUMBER = `${queryBody} WHERE \`tr\`.\`testNumber\` = ?`;

export { TEST_RECORD_BY_VIN, TEST_RECORD_BY_VRM, TEST_RECORD_BY_TEST_NUMBER };
