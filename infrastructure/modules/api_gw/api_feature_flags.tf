resource "aws_api_gateway_resource" "feature_flags" {
  parent_id   = aws_api_gateway_rest_api.apigw.root_resource_id
  path_part   = "feature-flags"
...
module "feature_flags" {
  ...
  resource_id   = aws_api_gateway_resource.feature_flags.id
  api_id        = aws_api_gateway_rest_api.apigw.id
  lambda_name   = var.lambdas.feature_flags
}
